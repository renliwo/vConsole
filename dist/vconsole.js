/*!
 * vconsole v0.1.0 (https://github.com/renliwo/vConsole)
 * Copyright 2017, zhipeng lu
 * MIT license
 */
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"homepage": "https://github.com/renliwo/vConsole",
		"main": "dist/vconsole.min.js",
		"scripts": {
			"test": "mocha",
			"dist": "webpack --config webpack.config.dev.js",
		...
		"repository": {
			"type": "git",
			"url": "git+https://github.com/renliwo/vConsole"
		},
		"dependencies": {},
		"devDependencies": {
			"babel-core": "^6.7.7",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/.0.23.1@css-loader/index.js!../../node_modules/.2.2.3@less-loader/index.js!./core.less", function() {
				var newContent = require("!!../../node_modules/.0.23.1@css-loader/index.js!../../node_modules/.2.2.3@less-loader/index.js!./core.less");
	  ...
	  _createClass(VConsoleNetworkTab, [{
	    ...
	    value: function mockFetch() {
	      ...
	      window.fetch = function (url) {
	        ...
	        item.startTime = new Date();
	        item.readyState = 0;
	        return _fetch(url, options).then(function (q) {
	          item.readyState = 4;
